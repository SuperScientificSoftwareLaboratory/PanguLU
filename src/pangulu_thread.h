#ifndef PANGULU_THREAD_H
#define PANGULU_THREAD_H
...
void pangulu_bsem_init(bsem *bsem_p, int_t value)
{
    if (value < 0 || value > 1)
    {
        exit(1);
...
int_t pangulu_bsem_wait(pangulu_heap *heap)
{
